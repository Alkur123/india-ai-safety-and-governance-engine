...
*   **Medical Blocking:** [View Medical Action](demo%20ui%20screenshots/1_medical_intent_IMC.jpeg) - Enforcing Indian Medical Council Act by blocking prescription requests.
*   **Self-Harm Prevention:** [View Self-Harm Prevention](demo%20ui%20screenshots/2_selfharm_mental_health.jpeg) - Immediate detection and blocking of self-harm related queries.
*   **Financial Regulation:** [View Financial Regulation](demo%20ui%20screenshots/3_sebi_financial_blocking.jpeg) - Enforcing SEBI regulations against unauthorized investment advice.
*   **PII Redaction:** [View PII Redaction](demo%20ui%20screenshots/4_pii_aadhaar_redaction.jpeg) - Zero-trust redaction of Aadhaar numbers before processing.
*   **Educational Content:** [View Educational Content](demo%20ui%20screenshots/5_educational_aspirin.jpeg) - Distinguishing between allowed educational queries and blocked medical advice.
*   **Governance Dashboard:** [View Governance Dashboard](demo%20ui%20screenshots/6_Metrics_governance_dashboard.jpeg) - Real-time metrics and decision traces.
*   **Support Mode:** [View Support Mode](demo%20ui%20screenshots/7_support_mode.jpeg) - Routing specific high-trust intents to human agent support mode.
*   **Session Risk (Stateful Escalation):** [View Session Risk](demo%20ui%20screenshots/8_session_risk.jpeg) - Multi-turn conversational penalty tracking and behavioral escalation blocking.
